...
const int z = 1; //z è il moltiplicatore per la vita del boss
...
protected:
	...
	int Hp; // HP attuali
	char name[10];// nome
	int damagest, damage1; // damagest è l'attacco standard, damage1 quello che attacca tutti i giocatori
public:
